...
var MapStore = Reflux.createStore({
	...
	init: function() {
		this.listenTo(LocationStore, this._updatePosition, this._updatePosition);
	},
	...
	onPullMapParams: function(geoPoints, dims) {
		...
		************************************************************************/
		...
		MapActions.pullMapParams.completed(params);
	},
	...
	onMakeAnnotations: function(items) {
		...
		MapActions.makeAnnotations.completed(annotations);
	},
